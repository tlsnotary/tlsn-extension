...
export function initialize(
  logging_config: LoggingConfig | null | undefined,
  thread_count: number,
): Promise<void>;
...
export interface InitOutput {
  ...
  readonly wasm_bindgen_57db2e356bef66d7___closure__destroy___dyn_core_a0678809250066c8___ops__function__FnMut__wasm_bindgen_57db2e356bef66d7___JsValue____Output_______: (
    a: number,
    b: number,
  ) => void;
  readonly wasm_bindgen_57db2e356bef66d7___closure__destroy___dyn_core_a0678809250066c8___ops__function__FnMut__wasm_bindgen_57db2e356bef66d7___JsValue____Output___core_a0678809250066c8___result__Result_____wasm_bindgen_57db2e356bef66d7___JsError___: (
    a: number,
    b: number,
  ) => void;
  readonly wasm_bindgen_57db2e356bef66d7___convert__closures_____invoke___wasm_bindgen_57db2e356bef66d7___JsValue__core_a0678809250066c8___result__Result_____wasm_bindgen_57db2e356bef66d7___JsError___true_: (
    a: number,
    b: number,
    c: any,
  ) => [number, number];
  ...
  readonly wasm_bindgen_57db2e356bef66d7___convert__closures_____invoke___wasm_bindgen_57db2e356bef66d7___JsValue______true_: (
    a: number,
    b: number,
    c: any,
  ) => void;
  readonly wasm_bindgen_57db2e356bef66d7___convert__closures_____invoke___web_sys_bc2fb9f0f68233a4___features__gen_MessageEvent__MessageEvent______true_: (
    a: number,
    b: number,
    c: any,
  ) => void;
