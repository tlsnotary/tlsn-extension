  ...
  return (
    <div id="mode-comparison" className="content-card">
      ...
      <p className="section-subtitle">
        MPC is the most trustless protocol TLSNotary offers, but its performance is bandwidth- and
        latency-sensitive — real-world connections can feel slow. Proxy mode is significantly
        faster, but offers the verifier weaker guarantees. If your
        trust model allows it, try the speed difference on your own connection.
      </p>
