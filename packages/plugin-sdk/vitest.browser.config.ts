...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      fs: path.resolve(__dirname, './test/mocks/node-fs-mock.js'),
      'fs/promises': path.resolve(__dirname, './test/mocks/node-fs-promises-mock.js'),
      crypto: path.resolve(__dirname, './test/mocks/node-crypto-mock.js'),
      events: 'events',
      util: 'util',
      'node:fs': path.resolve(__dirname, './test/mocks/node-fs-mock.js'),
      'node:fs/promises': path.resolve(__dirname, './test/mocks/node-fs-promises-mock.js'),
      'node:path': 'path-browserify',
      'node:stream': 'stream-browserify',
      'node:buffer': 'buffer',
      'node:crypto': path.resolve(__dirname, './test/mocks/node-crypto-mock.js'),
      'node:events': 'events',
      'node:util': 'util',
      cluster: path.resolve(__dirname, './test/mocks/empty-module.js'),
      url: path.resolve(__dirname, './test/mocks/empty-module.js'),
    },
  },
  define: {
    'process.env': {},
